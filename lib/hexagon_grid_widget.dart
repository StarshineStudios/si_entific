                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: <Widget>[
                          ...
                          _buildHexagon(
                            1.5 * radius,
                            -0.86602540378 * radius,
                            board.hexes[0].toString(),
                            0,
                            board.hexes[0].getColor(),
                          ),
                          _buildHexagon(
                            0,
                            -2 * 0.86602540378 * radius,
                            board.hexes[1].toString(),
                            1,
                            board.hexes[1].getColor(),
                          ),
                          _buildHexagon(
                            1.5 * radius,
                            0.86602540378 * radius,
                            board.hexes[2].toString(),
                            2,
                            board.hexes[2].getColor(),
                          ),
                          _buildHexagon(
                            0,
                            0,
                            board.hexes[3].toString(),
                            3,
                            board.hexes[3].getColor(),
                          ),
                          _buildHexagon(
                            -1.5 * radius,
                            -0.86602540378 * radius,
                            board.hexes[4].toString(),
                            4,
                            board.hexes[4].getColor(),
                          ),
                          _buildHexagon(
                            0,
                            2 * 0.86602540378 * radius,
                            board.hexes[5].toString(),
                            5,
                            board.hexes[5].getColor(),
                          ),
                          _buildHexagon(
                            -1.5 * radius,
                            0.86602540378 * radius,
                            board.hexes[6].toString(),
                            6,
                            board.hexes[6].getColor(),
                          ),
